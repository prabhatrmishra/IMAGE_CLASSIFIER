...
def predict(my_image, parameters):
    ...
    if Al > 0.5 :
        print("This is a cat picture (  Confidentiality (in percent) ")
    else:
        print("This is some ome other picture ")
    print("Confidentiality  :: -" , Al)
...
for  input_image,image_label in dataset:
    ...
    print("Y label ---------->" , label.index(image_label))
...
train_x_orig,test_x_orig, train_y, test_y = train_test_split(X, Y, test_size= 0.1 , random_state=7)
...
## START CODE HERE ##
my_image = "predict_test.jpg" # change this to the name of your image file 
my_label_y = [1] # the true class of your image (1 -> cat, 0 -> non-cat)
## END CODE HERE ##

fname = "test_image/" + my_image
my_image = cv2.imread(fname)
my_image = cv2.resize(img, (64, 64 ))

#plt.imshow(my_image)
predict_x_flatten = my_image.reshape((num_px * num_px * 3,1))
my_image = predict_x_flatten/255


predict(my_image, parameters)
